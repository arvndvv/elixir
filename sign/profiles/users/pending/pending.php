...
<i class="fa fa-info my-float"></i>
  ...
  <center><h2 class="heading">Pending</h2></center>

<div id='pend' class='flx '>
...
<div class='modl stack-top'>
        <div class='modl-content'>
          ...
          <br>
            ...
            <input class='formBtn view'  type='button' value='Ok!!' />
      ...
      <div class="modll773 stack-top">
        <div class="modll-content773">
          <center><h3 style="margin-top: 0px;">Did your work finished?</h3></center>
...
function finzz(p){
  var id=p;
  var one="<input type='button' onclick='donnnz(";
  var onne=");' class='assign' value='Yes'/>";
...
function donnnz(v){
  ...
  $.ajax({
                type: 'POST',
                url: '../pending/done.php',
                data: '&id='+id,
                success: function(html){
                  //document.getElementById(id).innerHTML=html;
                  if($.trim(html)=="true"){
                    fetchpending();
                    Notiflix.Report.Success("Done","Work Finished.","OK");
