...
<html><head><title>Employee</title>
<meta charset="utf-8" />
...
function setclientloca(latzz,lonzz){
  var latzz=latzz;
  var lonzz=lonzz;
document.getElementById("clientlati").value=latzz;
document.getElementById("clientlongi").value=lonzz;
//console.log(latzz);console.log(lonzz);
$('#content').load("../map/direction.php");
}
...
<input id="clientlati" type="hidden" readonly/>
<input  id="clientlongi" type="hidden" readonly/>
...
<input  id="geolongi" type="hidden" readonly/>
 ...
 <!-- popups notification -->
 <div class="modll stack-top">
        <div class="modll-content" style="overflow-y:auto; height:80%;">
...
<div is='sidem' class="page-wrapper chiller-theme ">
        ...
        <div id="nav" class="sidebar-menu">
          <ul>
            ...
            <li >
              ...
              <li >
              <a id="home" href="#" data-target="../profile/profile.php" >
              ...
              <li >
              <a id="home" href="#" data-target="../requests/requests.php" >
              ...
              <li >
              <a id="home" href="#" data-target="../pending/pending.php" >
              ...
              <li >
              <a id="home" href="#" data-target="../done/done.php" >
...
Notiflix.Block.Remove('.modll-content');
       },
       beforeSend: function () {
        Notiflix.Block.Init({ backgroundColor:"rgba(0,0,0,0.930)",svgColor:"#700000", }); 
        Notiflix.Block.Pulse('.modll-content');
       }
});
return false;
