...
if($row['accepted']==0 && $row['cancelled']==0 && $row['done']==0){
      ...
      <div class='image'>
        ...
        <div class='icons'>
          ...
          <a onclick='acce(".$id.");'><i class='fa fa-check-circle'></i></a>
...
<i class='fa fa-google' style='font-size: 24px;'></i>
    ...
    $found=1;}
   else if($row['accepted']==0 && $row['cancelled']==1 && $row['done']==0){
        echo "  <figure class='snip1268'>
        <div class='image'>
          <img src='".$row5['url']."' class='bgfix' style='background-color: white;
  ...
  <i class='fa fa-google' style='font-size: 24px;'></i>
      ...
      $found=1;}
      else if($row['accepted']==0 && $row['cancelled']==2 && $row['done']==0){
        echo "  <figure class='snip1268'>
        <div class='image'>
          <img src='".$row5['url']."' class='bgfix' style='background-color: white;
        ...
        border-bottom-right-radius: 20px;
        border-bottom-left-radius: 20px;'>
        <h4 style = 'text-transform:capitalize;'>".$row2['name']." <strong>  (Cancelled by user)  </strong>(".$row['bdate'].")</h4>
