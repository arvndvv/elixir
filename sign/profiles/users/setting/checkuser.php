...
<div class='row'>
  ...
  <div class='col-xs-12 col-md-6'><a onclick='update();' class='btn btn-success btn-block btn-lg'>Save</a></div>
    ...
    <hr class='colorgraph'><div style='margin-bottom: 20px;' class='col-xs-12 col-md-6'><a onclick='update();' class='btn btn-success btn-block btn-lg'>Save</a></div>

      <div class='col-xs-12 col-md-6'><a   class='btn btn-success btn-block btn-lg' ".$disable.">Delete account</a></div>
    ";
}else if($role=="worker"){
