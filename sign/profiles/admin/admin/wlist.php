  ...
  Notiflix.Confirm.Show(
   ...
   success: function (html) {
       if($.trim(html)=="true"){
		...
		$(".modll39").removeClass("show-modll39");
		var container=$('.wlist');
		container.load('../admin/wlist_get.php',{filter:""});
       }
      else{
...
var filter=$(this).val();
    ...
    container.load('../admin/wlist_get.php',{filter:filter});
});
</script>
<div class="container-fluid">
<div class="row justify-content-center ">
<span class="wsearch col-sm-7 justify-content-center p-0 m-0">
<input type='text' class="search  border border-elixir py-2 mt-5 my-3 pl-0 col-sm-12" placeholder="Search worker name"></input>
